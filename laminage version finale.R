...
split.screen(1:2)
screen(1);plot(T,cr,xlim=c(0,40),ylim = c(0,1500))
screen(2);plot(T,QS,xlim=c(0,40),ylim = c(0,1500))
return(max(cr))
return(max(QS))
return(max(NR))